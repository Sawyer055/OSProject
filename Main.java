...
public class Main {
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        String dosyaYolu = "C:\\Users\\Fatma\\Desktop\\is\\src\\giris.txt";
        int id=0;
        Color clr = new Color(); // her prosese renk atama işlemi için color sınıfından nesne olusturuluyor
        Kuyruk prosesler = new Kuyruk(); // txt dosyasından okumuş olduğum prosesleri prosesler kuyruğuna atanıyor
...
// txt dosyadan geldiği proseslerin özellikleri değikenlere atanıyor
